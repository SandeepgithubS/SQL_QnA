...
INSERT INTO Employee0 (Emp_No, Emp_Name, Job_Name, Manager_Id, HireDate, Salary, Commission, Department) VALUES
...
from each department who have a salary greater than the average salary in their department.*/
...
select 
    ...
    salary,
    department,
    round(avg(Salary) over(partition by department),0) as ag
from Employee0)
