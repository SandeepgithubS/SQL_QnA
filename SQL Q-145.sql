...
INSERT INTO os1 (customer_id, order_date, total_amount)
VALUES
...
select 
	order_date,
    customer_id,
    round(total_amount,0) as amt,
    round(sum(total_amount) over(partition by customer_id order by order_date ),0) as aa
from os1;
