...
INSERT INTO cu (customer_id, first_name, last_name, email) VALUES
...
customer_id, first_name, last_name, and email. Write an SQL query to find all the duplicate email addresses 
